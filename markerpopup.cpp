//Marker popup window when marker is invoked. Takes values for additional input for graph on mainwindow
...
void MarkerPopup::setCol() //previews the color selected by spinbox
{
...
void MarkerPopup::strListData(){ //takes color values from spinbox
